...
public class BitmapWorkerTask extends AsyncTask<Integer, Void, Integer> {
    ...
    public BitmapWorkerTask(String mpathImgToCrop, String mnewPath, String mname, int mxIni, int myIni, int mxFin, int myFin, Button mbt, Boolean mrelease,Context mcontext, String mprevname, Activity mactivity) {
